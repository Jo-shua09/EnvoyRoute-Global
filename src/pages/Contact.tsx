  ...
  const faqs = [
    {
      ...
      answer:
        "You can track your shipment using the tracking number provided in your confirmation email. Simply enter it on our tracking page or use the search bar in the header.",
    },
    {
      question: "What are your shipping rates?",
      answer:
        "Our rates vary based on destination, weight, and service type. Use our instant quote calculator on the homepage or contact our sales team for custom business pricing.",
    },
    {
      question: "Do you offer insurance for shipments?",
      answer:
        "Yes, all shipments include basic insurance coverage. Additional insurance options are available for high-value items through our Special Cargo service.",
    },
    {
      question: "What items cannot be shipped?",
      answer:
        "We cannot ship hazardous materials, illegal items, or perishable goods through standard services. Contact us for specialized handling of sensitive cargo.",
    },
    {
      question: "How do I schedule a pickup?",
      answer:
        "Business account holders can schedule pickups through their dashboard. For one-time pickups, contact our customer service team at least 24 hours in advance.",
    },
    {
      question: "What is your refund policy?",
      answer:
        "We offer refunds for undelivered shipments or service failures. Claims must be submitted within 30 days of the scheduled delivery date.",
    },
  ];
        ...
        <section className="py-16 gradient-hero">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-6">Contact & Support</h1>
              <p className="text-xl text-white/90">We're here to help 24/7. Get in touch with our team for any questions or support needs.</p>
            </div>
          </div>
        </section>
              ...
              <Card className="shadow-medium">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full bg-accent hover:opacity-90 text-accent-foreground" disabled={isSubmitting}>
                      {isSubmitting ? (
                        <>
                ...
                <Card className="shadow-medium bg-accent/5 border-accent/20">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      For partnership opportunities, bulk shipping solutions, or enterprise services, contact our business development team.
                    </p>
